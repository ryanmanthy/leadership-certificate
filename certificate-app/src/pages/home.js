...
const Home = () => {
  return (
    <div className="flex flex-col-reverse md:flex-row md:h-screen mx-auto bg-white" style={{ maxWidth: '1200px' }}>
        <Header title="IIT Leadership Certificate" />
        <div className="hidden md:block absolute top-0 right-0 bottom-0 w-1/2 bg-red-500" style={{ zIndex: -1 }}></div>
        <div className="hidden md:block absolute top-0 left-0 bottom-0 w-1/2 bg-white" style={{ zIndex: -1 }}></div>       
